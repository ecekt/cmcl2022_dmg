...
if __name__ == '__main__':
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="/project/dmg_data/cm/training_output_roberta_xlm_stack_ENDA_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("/project/dmg_data/cm/final_adapter_roberta_xlm_stack_ENDA_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    for split in datapaths_tests:
        ...
        if split == 'test1':
            ...
            test_text = parameter + '_test_2_xlm_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_stack_ENDA.txt'
