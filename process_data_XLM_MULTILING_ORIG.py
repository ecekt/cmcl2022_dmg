...
if __name__ == '__main__':
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="./training_output_roberta_xlm_" + parameter + "_" + single_lang,
    ...
    model.save_adapter("./final_adapter_roberta_xlm_" + parameter + "_" + single_lang, 'xlm_cmcl_' + single_lang)
    ...
    for split in datapaths_tests:
        ...
        if split == 'test1':
            test_text = parameter + '_test_1_xlm_' + single_lang +'.txt'
        elif split == 'test2':
            test_text = parameter + '_test_2_xlm_' + single_lang +'.txt'
