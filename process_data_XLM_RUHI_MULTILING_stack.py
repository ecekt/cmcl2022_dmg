...
if __name__ == '__main__':
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="/project/dmg_data/cm/training_output_roberta_xlm_1WP_stack_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("/project/dmg_data/cm/final_adapter_roberta_1WP_xlm_stack_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    for split in datapaths_tests:
        ...
        if split == 'test1':
            test_text = parameter + '_test_1_xlm_1WP_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_stack.txt'
        elif split == 'test2':
            test_text = parameter + '_test_2_xlm_1WP_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_stack.txt'
                ...
                for sent_id in dataset_param[lang]:
                    ...
                    for lm in label_map:
                        ...
                        if len(label_map[lm]) > 1:
                            ...
                            # multiple wordpieces
                            label_map[lm] = label_map[lm][0] # only the first wp np.mean(label_map[lm])
