...
if __name__ == '__main__':
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="./training_output_roberta_xlm_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("./final_adapter_roberta_xlm_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
