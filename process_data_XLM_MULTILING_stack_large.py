...
if __name__ == '__main__':
    ...
    single_lang = args.ln
    print(single_lang)
    print('stack adapters large xlm-roberta')
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="/project/dmg_data/cm/training_output_robertaLARGE_xlm_stack_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("/project/dmg_data/cm/final_adapter_roberta_LARGE_xlm_stack_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    for split in datapaths_tests:
        ...
        if split == 'test1':
            test_text = parameter + '_test_1_LARGExlm_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_stack.txt'
        elif split == 'test2':
            test_text = parameter + '_test_2_LARGExlm_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_stack.txt'
