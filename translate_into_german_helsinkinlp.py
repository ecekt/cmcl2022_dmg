...
datapaths_translated2 = {'test2': 'data/translated/test2_de.csv'}
...
tokenizer_daen = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-da-de")
model_daen = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-da-de")
