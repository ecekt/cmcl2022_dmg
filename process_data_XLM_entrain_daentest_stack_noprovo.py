...
if __name__ == '__main__':
    ...
    single_lang = args.ln
    print(single_lang)
    print('stack adapters xlm-roberta noprovo')
            ...
            for idx, line in enumerate(csvreader):
                ...
                if idx == 0:
                    ...
                    if split in ['train', 'val']:
                        ...
                        if language == single_lang and 'Provo-' not in sentence_id: # skip provo
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="/project/dmg_data/cm/training_output_roberta_xlm_stack_ENDA_noprovo_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("/project/dmg_data/cm/final_adapter_roberta_xlm_stack_ENDA_noprovo_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
                       + str(batch_size) + '_' + str(epochs), 'xlm_cmcl_' + single_lang)

    # TODO TEST set convert to id actual token etc. labels for answers
    datapaths_tests = {'test2': 'data/translated/test2_en.csv'} # danish test translated into english
    ...
    for split in datapaths_tests:
        ...
        if split == 'test1':
            ...
            test_text = parameter + '_test_2_xlm_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_stack_ENDA_noprovo.txt'
