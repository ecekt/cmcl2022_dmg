...
if __name__ == '__main__':
    ...
    single_lang = args.ln
    print(single_lang)
    print('init adapters xlm-roberta')
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="/project/dmg_data/cm/training_output_roberta_xlm_init_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("/project/dmg_data/cm/final_adapter_roberta_xlm_init_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
                       + str(batch_size) + '_' + str(epochs), 'xlm_cmcl_' + single_lang)

    # TODO TEST set convert to id actual token etc. labels for answers
    # 'test1': 'data/test_data_subtask1/test_data_subtask1/test.csv',
    datapaths_tests = {'test2': 'data/test_data_subtask2/test_data_subtask2/test.csv'}
    ...
    for split in datapaths_tests:
        ...
        if split == 'test1':
            test_text = parameter + '_test_1_xlm_' + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_' \
                        + str(batch_size) + '_' + str(epochs) + '_init.txt'
        elif split == 'test2':
