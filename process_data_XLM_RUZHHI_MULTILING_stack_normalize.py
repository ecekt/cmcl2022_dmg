...
if __name__ == '__main__':
    ...
    param_mean = float(np.mean(param_range))
                ...
                for sent_id in ds[lang]:
                    ...
                    for w_i, wps in enumerate(tokenized['input_ids']):
                        ...
                        for wp in wps:
                            ...
                            normalized_label = orig_labels[w_i] - param_mean
    ...
    model.add_adapter(adapter_name_lang, config=lang_adapter_config)
    ...
    training_args = TrainingArguments(
        ...
        logging_steps=200,
        output_dir="/project/dmg_data/cm/training_output_roberta_xlm_stack_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
    ...
    model.save_adapter("/project/dmg_data/cm/final_adapter_roberta_xlm_stack_" + parameter + "_" + single_lang + '_' + str(seed) + '_' + str(learning_rate) + '_'
                ...
                for sent_id in dataset_param[lang]:
                    ...
                    for lm in label_map:
                        ...
                        if len(label_map[lm]) > 1:
                            ...
                            # multiple wordpieces
                            label_map[lm] = np.mean(label_map[lm]) + param_mean

                        else:
                            label_map[lm] = label_map[lm][0] + param_mean
